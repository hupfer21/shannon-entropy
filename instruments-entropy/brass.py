...
mp3 = []
mp3_1, sr1 = a2n.audio_from_file("tubaA3.mp3")
mp3_2, sr2 = a2n.audio_from_file("tromboneA3.mp3")
mp3_3, sr3 = a2n.audio_from_file("trumpetA3.mp3")
mp3_4, sr4 = a2n.audio_from_file("frenchhornA3.mp3")
mp3.append(mp3_1)
mp3.append(mp3_2)
mp3.append(mp3_3)
mp3.append(mp3_4)
...
y = [0, 0, 1, 1]
x = [0, 1, 0, 1]
instrumento = ["Tuba", "Trombone", "Trumpet", "French Horn"]
for i in range(len(mp3)):
